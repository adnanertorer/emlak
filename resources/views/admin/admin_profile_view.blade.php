                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.profile.store') }}" class="forms-sample" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <img id="showImage" class="wd-80 rounded-circle" src="{{ (!empty($profileData->photo)) ? url(Vite::asset('public/upload/admin_images/').$profileData->photo) : url(Vite::asset('public/upload/no_image.jpg')) }}" alt="profile">
                                </div>
