        ...
        <ul class="nav">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.package.history') }}" class="nav-link">
                    ...
                    <span class="link-title">Paket Satış Geçmişi</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="collapse" href="#uiComponents" role="button"
                   aria-expanded="false" aria-controls="uiComponents">
                    ...
                    <span class="link-title">Acenta Yönetimi</span>
                    <i class="link-arrow" data-feather="chevron-down"></i>
                </a>
                <div class="collapse" id="uiComponents">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ route('all.agent') }}" class="nav-link">Acentalar</a>
                        </li>
                        <li class="nav-item">
                            <a href="pages/ui-components/alerts.html" class="nav-link">Acenta Ekle</a>
                        </li>
                    </ul>
                </div>
            </li>
