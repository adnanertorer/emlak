...
@section('main')
    ...
    <section class="page-title-two bg-color-1 centred">
        <div class="pattern-layer">
            <div class="pattern-1" style="background-image: url({{ Vite::asset('public/frontend/assets/images/shape/shape-9.png') }});"></div>
            <div class="pattern-2" style="background-image: url({{ Vite::asset('public/frontend/assets/images/shape/shape-10.png') }});"></div>
        </div>
    ...
    <section class="subscribe-section bg-color-3">
        <div class="pattern-layer" style="background-image: url({{ Vite::asset('public/assets/images/shape/shape-2.png')}});"></div>
        <div class="auto-container">
            <div class="row clearfix">
