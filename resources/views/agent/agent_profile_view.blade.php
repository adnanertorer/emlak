                ...
                <div class="card rounded">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            <div>
                                <img class="wd-100 rounded-circle" src="{{ (!empty($profileData->photo)) ? url(Vite::asset('public/upload/agent_images/').$profileData->photo) : url(Vite::asset('public/upload/no_image.jpg')) }}" alt="profile">
...
url(Vite::asset('public/upload/agent_images/').$profileData->photo) : url(Vite::asset('public/upload/no_image.jpg')) }}" alt="profile">
                                </div>
