                        ...
                        <div class="post-inner">
                            <div class="post">
                                <figure class="post-thumb"><a href="blog-details.html">
                                        <img src="{{Vite::asset('public/frontend/assets/images/resource/footer-post-1.jpg')}}" alt=""></a></figure>
                                <h5><a href="blog-details.html">The Added Value Social Worker</a></h5>
                                <p>Mar 25, 2020</p>
                            </div>
                            <div class="post">
                                <figure class="post-thumb"><a href="blog-details.html">
                                        <img src="{{Vite::asset('public/frontend/assets/images/resource/footer-post-2.jpg')}}" alt=""></a></figure>
    ...
    <div class="footer-bottom">
        <div class="auto-container">
            <div class="inner-box clearfix">
                <figure class="footer-logo"><a href="index.html"><img src="{{Vite::asset('public/frontend/assets/images/footer-logo.png')}}" alt=""></a></figure>
