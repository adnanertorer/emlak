            ...
            <div class="items-container row clearfix">
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all illustration brand marketing software">
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="{{Vite::asset('public/frontend/assets/images/resource/place-1.jpg')}}" alt=""></figure>
                            <div class="text">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all brand illustration print software logo">
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="{{Vite::asset('public/frontend/assets/images/resource/testimonial-2.jpg')}}" alt=""></figure>
                            <div class="text">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all illustration marketing logo">
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="{{Vite::asset('public/frontend/assets/images/resource/place-3.jpg')}}" alt=""></figure>
                            <div class="text">
                ...
                <div class="col-lg-8 col-md-6 col-sm-12 masonry-item small-column all brand marketing print software">
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="{{Vite::asset('public/frontend/assets/images/resource/place-4.jpg')}}" alt=""></figure>
                            <div class="text">
